<?php //This page checks for required content, errors, and provides sticky output
	...
	if (!$missing && !$errors) {
		...
		$sql = "INSERT into Ca_Reg_User (firstname, lastname, emailAddr, pw, manager, folder) VALUES (:fname, :lname, :email, :pw, :manager, :folder); INSERT into employee (e_id, fname, lname, address, city, state, zip, phone, email, manager) VALUES (:e_id, :fname, :lname, :address, :city, :state, :zipcode, :phone, :email, :manager)";
